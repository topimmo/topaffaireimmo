...
export function getNeighborhoodsByCity(citySlug) {
    return MOROCCO_NEIGHBORHOODS[citySlug] || [];
}
/**
 * Find a neighborhood by slug across all cities
 */
export function findNeighborhood(slug) {
    return getAllNeighborhoods().find(n => n.slug === slug);
}
/**
 * Find a neighborhood by city and slug
 */
export function findNeighborhoodInCity(citySlug, neighborhoodSlug) {
 ...
 */
export function generatePropertySearchUrl(transaction, propertyType, city, neighborhood) {
    const parts = [];
    // Transaction type
 ...
 */
export function generateMetaDescription(transaction, propertyType, city, neighborhood) {
 ...
 */
export function generatePageTitle(transaction, propertyType, city, neighborhood) {
