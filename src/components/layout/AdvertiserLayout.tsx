...
const menuItems = [
  ...
  },
  {
    ...
    href: "/advertiser/media",
    badge: null,
  },
  {
    icon: Inbox,
    labelFr: "Leads & Messages",
    labelAr: "العملاء والرسائل",
  ...
  {
    icon: Rocket,
    labelFr: "Booster mes annonces",
    labelAr: "تعزيز إعلاناتي",
    href: "/advertiser/boost",
    badge: null,
  },
  {
    icon: User,
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-medium text-sm truncate">
                  {user?.user_metadata?.full_name || "Annonceur"}
                </p>
                <Badge variant="secondary" className="mt-1 text-xs">
                  <Building2 className="w-3 h-3 mr-1" />
                  {isRTL ? "معلن عقاري" : "Annonceur"}
                </Badge>
              </div>
            </div>
          </div>
