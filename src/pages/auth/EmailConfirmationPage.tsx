        ...
        <Card className="bg-[#1B2F3C] border-[#2A3F4C] shadow-2xl">
          <CardContent className="p-8 text-center space-y-6">
            ...
            <div className="space-y-3">
              ...
              <Button variant="outline" className="w-full border-[#2A3F4C] text-gray-300 hover:bg-[#0A1F2E] hover:text-white">
                Renvoyer l'email
              </Button>
            </div>
            ...
            <p className="text-xs text-gray-500">
              ...
              <a href="#" className="text-[#0FC2C0] hover:underline">contactez le support</a>.
            </p>
          </CardContent>
        </Card>
      </div>
