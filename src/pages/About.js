...
export default function About() {
    ...
    return (_jsxs("div", { className: `min-h-screen flex flex-col bg-background ${isRTL ? 'rtl' : 'ltr'}`, children: [_jsx(Header, {}), _jsxs("main", { className: "flex-1 pt-24 pb-16", children: [_jsx("section", { className: "container mb-16", children: _jsxs("div", { className: "max-w-3xl", children: [_jsx("h1", { className: "font-display text-4xl md:text-5xl font-semibold text-foreground mb-6", children: c.title }), _jsx("p", { className: "text-xl text-muted-foreground leading-relaxed", children: c.subtitle })] }) }), _jsx("section", { className: "bg-primary text-white py-16 mb-16", children: _jsx("div", { className: "container", children: _jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-8", children: c.stats.map((stat) => (_jsxs("div", { className: "text-center", children: [_jsx(stat.icon, { className: "h-8 w-8 mx-auto mb-4 opacity-80" }), _jsx("p", { className: "font-display text-3xl md:text-4xl font-semibold mb-2", children: stat.value }), _jsx("p", { className: "text-white/70", children: stat.label })] }, stat.label))) }) }) }), _jsxs("section", { className: "container", children: [_jsxs("div", { className: "grid md:grid-cols-2 gap-12 items-center mb-16", children: [_jsx("div", { className: isRTL ? 'order-2 md:order-2' : '', children: _jsx("img", { src: "https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&q=80", alt: "Real estate team", className: "rounded-2xl" }) }), _jsxs("div", { className: isRTL ? 'order-1 md:order-1' : '', children: [_jsx("h2", { className: "font-display text-3xl font-semibold mb-4", children: c.storyTitle }), _jsx("p", { className: "text-muted-foreground mb-4", children: c.storyP1 }), _jsx("p", { className: "text-muted-foreground mb-4", children: c.storyP2 }), _jsx("p", { className: "text-muted-foreground", children: c.storyP3 })] })] }), _jsxs("div", { className: "grid md:grid-cols-2 gap-12 items-center mb-16", children: [_jsxs("div", { className: isRTL ? 'order-1 md:order-2' : 'order-2 md:order-1', children: [_jsx("h2", { className: "font-display text-3xl font-semibold mb-4", children: c.valuesTitle }), _jsx("div", { className: "space-y-6", children: c.values.map((value) => (_jsxs("div", { children: [_jsx("h3", { className: "font-semibold text-lg mb-2", children: value.title }), _jsx("p", { className: "text-muted-foreground", children: value.description })] }, value.title))) })] }), _jsx("div", { className: isRTL ? 'order-2 md:order-1' : 'order-1 md:order-2', children: _jsx("img", { src: "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=800&q=80", alt: "Team collaboration", className: "rounded-2xl" }) })] }), _jsxs("div", { className: "bg-primary/5 rounded-2xl p-8 md:p-12 text-center", children: [_jsx("h2", { className: "font-display text-2xl md:text-3xl font-semibold mb-4", children: c.freeListingTitle }), _jsx("p", { className: "text-muted-foreground max-w-2xl mx-auto", children: c.freeListingDescription })] })] })] }), _jsx(Footer, {})] }));
}
