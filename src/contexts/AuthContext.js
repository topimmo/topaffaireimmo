...
export function AuthProvider({ children }) {
    ...
    const signUp = async (email, password, fullName, phone, userRole, companyName) => {
        console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
        ...
        if (!isSupabaseConfigured) {
            ...
            return { error: { message: 'Configuration Supabase manquante. Veuillez vérifier les variables d\'environnement.' } };
        }
    ...
    return (_jsx(AuthContext.Provider, { value: { user, profile, session, loading, profileLoading, signUp, signIn, signOut }, children: children }));
}
